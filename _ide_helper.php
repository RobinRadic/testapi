...
if (!function_exists('with')) {
    ...
    class Api extends \App\Facades\Api\Api{
    ...
    class Auth extends \App\Facades\Api\Auth{
         ...
         * @static 
         */
        public static function getUser($authenticate = true){
            return \App\Auth::getUser($authenticate);
        }
         ...
         * @static 
         */
        public static function user($authenticate = true){
         ...
         * @static 
         */
        public static function authenticate($providers = array()){
            //Method inherited from \Dingo\Api\Auth\Auth            
            return \App\Auth::authenticate($providers);
        }
         ...
         * @static 
         */
        public static function check($authenticate = true){
            //Method inherited from \Dingo\Api\Auth\Auth            
            return \App\Auth::check($authenticate);
        }
         ...
         * @static 
         */
        public static function getProviderUsed(){
            //Method inherited from \Dingo\Api\Auth\Auth            
            return \App\Auth::getProviderUsed();
        }
         ...
         * @static 
         */
        public static function extend($key, $provider){
            //Method inherited from \Dingo\Api\Auth\Auth            
            \App\Auth::extend($key, $provider);
        }
        
    }


    class Response extends \App\Facades\Api\Response{
        ...
        public static function noContent(){
            return \Dingo\Api\Http\Response\Factory::noContent();
        }
        ...
        public static function error($message, $statusCode){
            \Dingo\Api\Http\Response\Factory::error($message, $statusCode);
        }
        ...
        public static function errorNotFound($message = 'Not Found'){
            \Dingo\Api\Http\Response\Factory::errorNotFound($message);
        }
        ...
        public static function errorBadRequest($message = 'Bad Request'){
            \Dingo\Api\Http\Response\Factory::errorBadRequest($message);
        }
        ...
        public static function errorForbidden($message = 'Forbidden'){
            \Dingo\Api\Http\Response\Factory::errorForbidden($message);
        }
        ...
        public static function errorInternal($message = 'Internal Error'){
            \Dingo\Api\Http\Response\Factory::errorInternal($message);
        }
    ...
    class Transformer extends \App\Facades\Api\Transformer{
         ...
         * @static 
         */
        public static function transform($response){
            return \Dingo\Api\Transformer\Factory::transform($response);
        }
         ...
         * @static 
         */
        public static function transformableResponse($response){
            return \Dingo\Api\Transformer\Factory::transformableResponse($response);
        }
         ...
         * @static 
         */
        public static function transformableType($value){
            return \Dingo\Api\Transformer\Factory::transformableType($value);
        }
         ...
         * @static 
         */
        public static function getTransformerBindings(){
            return \Dingo\Api\Transformer\Factory::getTransformerBindings();
        }
        ...
        public static function setAdapter($adapter){
            \Dingo\Api\Transformer\Factory::setAdapter($adapter);
        }
        ...
        public static function getAdapter(){
            return \Dingo\Api\Transformer\Factory::getAdapter();
        }
